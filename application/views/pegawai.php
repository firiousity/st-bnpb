  ...
  <tbody>
    ...
    foreach ($pegawai as $row) {
                echo "
                  ...
                  <td>
                  <span class='table-remove'><a href='".base_url("home/delete_pegawai/$row->id_pegawai")."'><button type='button' class='btn btn-danger btn-sm my-0'><i class='fa fa-times' aria-hidden='true'></i></button></span>
                  </td>
                    </tr>";
                     $counter++;}
                     ?>
