<body>
  <div class="container margin">
        <p style="font-size: 27px;">Tiket Pesawat</p>
                  <table id="tiket_pesawat" class="table table-responsive table-hover" cellspacing="0">
                          ...
                          <tbody>
                            ...
                            foreach ($pesawat as $row) {
                              ...
                              <td>
                                <span class='table-remove'><a href='".base_url("home/edit_tiket_page/$row->id")."'><button type='button' class='btn btn-danger btn-rounded btn-sm my-0'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></button></span>
                              </td>
                              <td>
