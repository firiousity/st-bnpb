        ...
        <p style="font-size: 27px; text-align: center; padding-top: 50px;">Dasar Hukum</p>
            <table class="table" cellspacing="0">
                ...
                <tr>
                              ...
                              <td>
                                 <span class='table-remove'><button onclick='delete_hukum($row->id)' type='button' class='btn btn-danger btn-sm my-0'><i class='fa fa-times' aria-hidden='true'></i></button></span>
                              </td>
                            </tr>
                            ";
              $counter++;}
        ...
        <a href="#"> <button class="btn animated bounceInLeft btn-indigo" type="button" data-toggle="modal" data-target="#modalRegisterForm1" id="main"><i class="fa fa-plus" aria-hidden="true">
                  ...
                  <script>
                    ...
                    swalWithBootstrapButtons({
                      ...
                      if (result.value) {
                        window.location = '<?php echo base_url() ?>home/delete_hukum/'+id;
                      } else if (
    ...
    <div class="modal fade" id="modalRegisterForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <form action="<?php echo base_url('home/tambah_hukum') ?>" method="post">
            <div class="modal-body mx-5">
              <div class="md-form mb-4">
                <input type="text" class="form-control" name="hukum">
