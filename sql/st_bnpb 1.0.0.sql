...
-- Dumping data for table st_bnpb.biaya_transport: ~5 rows (approximately)
...
-- Dumping data for table st_bnpb.data_rinci: ~2 rows (approximately)
...
INSERT INTO `pembayaran_awal` (`id`, `id_surat`, `id_pegawai`, `penginapan`, `harian`, `transport`, `tiket`, `representasi`, `total`) VALUES
	(1, 1, 38, 530000, 370000, 976000, 4492000, 0, 8538000),
	(2, 1, 39, 480000, 430000, 942000, 7081000, 0, 11183000);
...
CREATE TABLE IF NOT EXISTS `spd_rampung` (
  ...
  `id_surat` int(5) NOT NULL,
  `id_pegawai` int(10) DEFAULT NULL,
  `multiple` varchar(3) DEFAULT '"0"',
  `malam` tinyint(3) DEFAULT '0',
...
INSERT INTO `spd_rampung` (`id`, `id_surat`, `id_pegawai`, `multiple`, `malam`, `penginapan`, `transport`, `harian`, `tiket`, `representasi`, `total`) VALUES
	(1, 1, 38, '0', 3, 123123, 512000, 370000, 1200000, NULL, 3561369),
	(2, 1, 39, '1', 1, 222222, 512000, 430000, 1300000, NULL, 3754222),
	(3, 1, 39, '1', 2, 331233, 512000, 430000, 1300000, NULL, 4194466);
...
-- Dumping data for table st_bnpb.surat_dinas: ~1 rows (approximately)
...
-- Dumping data for table st_bnpb.yang_dinas: ~2 rows (approximately)
